...
def main() -> int:
    ...
    metrics = {
        ...
        "device": str(device),
        "class_convention": {"0": "pre-DBS", "1": "post-DBS"},
    ...
    md = [
        ...
        "",
        "Class 0 represents pre-DBS images and Class 1 represents post-DBS images. The analysis evaluates image-level explanation consistency.",
        "",
