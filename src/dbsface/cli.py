...
MODULE_IMPORTS: dict[str, str] = {
    ...
    "analyze_aev_confidence_matched": "dbsface.experiments.analyze_aev_confidence_matched",
    "analyze_aev_cluster_robust_stats": "dbsface.experiments.analyze_aev_cluster_robust_stats",
    ...
    "run_confound_net_increment": "dbsface.experiments.run_confound_net_increment",
    ...
    "run_similarity_alignment_audit": "dbsface.robustness.run_similarity_alignment_audit",
